...
//    }
    ...
    public Employee getEmployee(int ID)
    {
        try
        {
            ...
            // Create string for SQL statement
            String strSelect =
                    "SELECT e.emp_no,e.first_name, e.last_name,t.title,s.salary,d.dept_name,  CONCAT(m.first_name, ' ', m.last_name) AS manager "
                            + "FROM employees e "
    ...
    public Department getDepartment(String deptName) {
        try {
            Statement stmt = con.createStatement();
            String strSelect = "SELECT dept_no, dept_name FROM departments WHERE dept_name = '" + deptName + "'";
            ResultSet rset = stmt.executeQuery(strSelect);
    ...
    public ArrayList<Employee> getSalariesByDepartment(Department dept) {
        ...
        try {
            ...
            System.out.println(e.getMessage());
            System.out.println("Failed to get employees for department");
            return null;
        }
    }
